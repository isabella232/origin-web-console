...
(function(root, factory) {
  ...
  "use strict";
    ...
    return angular.module('kubernetesUI')
        ...
        .directive('kubernetesContainerTerminalKubevirt', [
                ...
                return {
                    ...
                    link: function(scope, element/*, attrs*/) {
                        ...
                        function connect() {
                            ...
                            $q.when(kubernetesContainerSocket(url, "plain.kubevirt.io"/*"base64.channel.k8s.io"*/),
                                function resolved(socket) {
                                    ws = socket;

                                    ws.onopen = function(/* ev */) {
                                        // plain.kubevirt.io: resizing does not work
